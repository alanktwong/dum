...
func TestEnvLevel_Default(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "")
	assert.Equal(t, log.WarnLevel, EnvLevel())
}

func TestEnvLevel_Debug(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "debug")
	assert.Equal(t, log.DebugLevel, EnvLevel())
}

func TestEnvLevel_Info(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "info")
	assert.Equal(t, log.InfoLevel, EnvLevel())
}

func TestEnvLevel_Warn(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "warn")
	assert.Equal(t, log.WarnLevel, EnvLevel())
}

func TestEnvLevel_Error(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "error")
	assert.Equal(t, log.ErrorLevel, EnvLevel())
}

func TestEnvLevel_Fatal(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "fatal")
	assert.Equal(t, log.FatalLevel, EnvLevel())
}

func TestEnvLevel_InvalidString(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "invalid")
	assert.Equal(t, log.WarnLevel, EnvLevel())
}

func TestEnvLevel_Numeric_Debug(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "5")
	assert.Equal(t, log.DebugLevel, EnvLevel())
}

func TestEnvLevel_Numeric_10(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "10")
	assert.Equal(t, log.DebugLevel, EnvLevel())
}

func TestEnvLevel_Numeric_Info(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "15")
	assert.Equal(t, log.InfoLevel, EnvLevel())
}

func TestEnvLevel_Numeric_20(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "20")
	assert.Equal(t, log.InfoLevel, EnvLevel())
}

func TestEnvLevel_Numeric_Warn(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "25")
	assert.Equal(t, log.WarnLevel, EnvLevel())
}

func TestEnvLevel_Numeric_30(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "30")
	assert.Equal(t, log.WarnLevel, EnvLevel())
}

func TestEnvLevel_Numeric_Error(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "35")
	assert.Equal(t, log.ErrorLevel, EnvLevel())
}

func TestEnvLevel_Numeric_40(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "40")
	assert.Equal(t, log.ErrorLevel, EnvLevel())
}

func TestEnvLevel_Numeric_Fatal(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "45")
	assert.Equal(t, log.FatalLevel, EnvLevel())
}

func TestEnvLevel_Numeric_50(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "50")
	assert.Equal(t, log.FatalLevel, EnvLevel())
}

func TestEnvLevel_Numeric_Over50(t *testing.T) {
	t.Setenv("ZSH_LOG_LEVEL", "100")
	assert.Equal(t, log.WarnLevel, EnvLevel())
}
